...
from water_flow import conversion_kpa_to_psi
...
def test_conversion_kpa_to_psi():
      assert conversion_kpa_to_psi(0.00) == approx(0.000, abs = 0.001)
      assert conversion_kpa_to_psi(25.0) == approx(3.626, abs = 0.001)
      assert conversion_kpa_to_psi(158.7) == approx(23.018, abs = 0.001)
